...
public class AccountServices {
	...
	public static Customer createAccount(int customerChoice) {
		...
		if(customerChoice==1) {
			...
			System.out.println("Enter Customer Name: ");
			String customerName = scanner.nextLine();
			System.out.println("CurrentAccount created and you have services like CashDeposit,OnlineBanking,ATMWithdrawl,MobileBanking");
			...
			System.out.println("Enter Customer Name: ");
			String customerName = scanner.nextLine();
			System.out.println("LoanAccount created for CashDeposit,ChequeDeposit");
			customer = new Customer("Loan Account");
		}
		return customer;
		
	}
	
	public void manageAccount(ArrayList<Customer> customers,String customerCode) { //to display account details of a customer
